...
<?php
	...
	echo '<p><i>Vous êtes ici</i> : <a style="color:#64dae2;" href="../index.php">Index du forum</a> => 
	...
	echo ' <a href="deconnexion.php" style="margin-top:10px;color:#64dae2;float:right;"> Déconnexion </a>';
	//Nombre de pages
	...
	<img src="images/7.gif" alt="Répondre" title="Répondre à ce topic" /></a>';
	  
	//On affiche l'image nouveau topic
	echo'<a href="./poster.php?action=nouveautopic&amp;f='.$data['forum_id'].'">
	<img src="images/6.gif" alt="Nouveau topic" title="Créer un nouveau topic" /></a>';
	$query->CloseCursor(); 
